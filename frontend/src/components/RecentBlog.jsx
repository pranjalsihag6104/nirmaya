...
const tags = [
    ...
    {
        category: "Lifestyle and Nutrition"
    },
    {
        category: "Substance use and addictions"
    },
    {
    ...
    return (
        <div className='bg-gray-100 dark:bg-gray-800 pb-10'>
            <div className='max-w-6xl mx-auto  flex flex-col space-y-4 items-center'>
                <h1 className='text-4xl font-bold pt-10 '>Recent Articles</h1>
            ...
            <div className='max-w-7xl mx-auto flex gap-6'>
                ...
                <div className='bg-white hidden md:block dark:bg-gray-700 w-[350px] p-5 rounded-md mt-10'>
                    ...
                    {/* <h1 className='text-xl font-semibold '>Subscribe to Nirmaya Care</h1>
                    ...
                    {/* <div className='mt-7'>
                        ...
                        <ul className="space-y-3">
                            {[
                                ...
                                'Hemophilia: Living with the Rare Bleeding Disorder',
                                'Vitiligo',
                            ].map((title, idx) => (
                                <li
                                    key={idx}
