...
const CreateBlog = () => {
    ...
    return (
        <div className='p-4 md:pr-20 h-screen md:ml-[320px] pt-20'>
            ...
            <h1 className='text-2xl font-bold'>Lets Write Article</h1>
            <p>Share your thoughts . . .</p>
            <div className='mt-10 '>
                <div>
                    <Label>Title</Label>
                    <Input type="text" placeholder="Your Article Name" value={title} onChange={(e) => setTitle(e.target.value)} className="bg-white dark:bg-gray-700" />
                </div>
